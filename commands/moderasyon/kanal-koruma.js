...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription('Kanal silme/ekleme korumasını aç/kapat')
  ...
  async execute(interaction) {
    ...
    config[guildId].kanalKoruma = durum === 'ac';
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(`${interaction.user} kanal silme/ekleme korumasını **${durum === 'ac' ? 'AÇTI' : 'KAPATTI'}**.`)
