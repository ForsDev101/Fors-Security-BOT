...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription('Emoji silme/ekleme korumasını aç/kapat')
  ...
  async execute(interaction) {
    ...
    config[guildId].emojiKoruma = durum === 'ac';
    ...
    const embed = new EmbedBuilder()
      .setTitle('🎭 Emoji Koruması')
      .setDescription(`${interaction.user} emoji silme/ekleme korumasını **${durum === 'ac' ? 'AÇTI' : 'KAPATTI'}**.`)
